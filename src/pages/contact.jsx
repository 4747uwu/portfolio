...
export default function Contact() {
    return (
        <section id="contact" className="relative py-20 sm:py-28 bg-[#0a0a0a] overflow-hidden">
            {/* Separator */}
            <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/5 to-transparent" />

            {/* Fireworks — subtle celebratory background */}
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-base sm:text-lg max-w-md mx-auto">
                            Got an interesting problem? A wild idea? A production fire at 3am?
                            I'm probably awake. Let's talk.
                        </p>
                    </motion.div>
                    ...
                    >
                        {contactLinks.map((link, i) => (
                            <motion.a
                                ...
                                whileHover={{ y: -4 }}
                                className="flex items-center gap-3 px-6 py-4 bg-[#141414] border border-white/6 rounded-xl hover:border-cyan-500/20 transition-all duration-300 group w-full sm:w-auto"
                            >
                    ...
                    <motion.div
                        ...
                        className="inline-block bg-[#141414] border border-white/6 rounded-lg px-5 py-3"
                    >
                        <p className="font-mono text-sm text-gray-500">
                            <span className="text-cyan-400">$</span> echo "Available for interesting problems"
                ...
                >
                    <p className="text-xs text-gray-600 font-mono">
                        <span className="text-cyan-400/50">{'>'}_</span> built with react + coffee + 2am debugging sessions
                    </p>
                    <p className="text-xs text-gray-700 font-mono">
                        © {new Date().getFullYear()} — Lucknow, India
                    </p>
                </motion.div>
            </div>
        </section>
